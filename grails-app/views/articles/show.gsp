...
<html>
	...
	<body>
		...
		<div id="show-articles" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:articlesInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${articlesInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
