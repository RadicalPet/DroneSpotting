...
<g:each in="${articlesInstanceList}" status="i" var="articlesInstance">
    <g:if test="${articlesInstance.isPublished == true}">
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-heading panel-info">
                    <h4 class="panel-title"><g:link controller="MemberArticles" action="show" id="${articlesInstance.id}">${fieldValue(bean: articlesInstance, field: "title")}</g:link></h4>
                    </div>
